...
<%
	...
	Statement stmt = null; // stmt : 쿼리를 담아서 DB에 적용하는 객체 
	
	sql = "insert into guestboard (name, email, subject,contect)";
	sql = sql + " values ('" + na +"', '"+ em +"', '"+ sub +"', '"+ cont +"')"; // values 공백이 있어야함
	
	out.println(sql);
	//Statement 객체 를 활성화 : Connection 객체로 Statement 객체를 생성함.
